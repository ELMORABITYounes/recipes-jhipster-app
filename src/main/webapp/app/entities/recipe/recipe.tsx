...
export const Recipe = (props: IRecipeProps) => {
  ...
  const { recipeList, match, loading, totalItems } = props;
  return (
    <div>
            ...
            <tbody>
              {recipeList.map((recipe, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{recipe.author ? <Link to={`author/${recipe.author.id}`}>{recipe.author.id}</Link> : ''}</td>
                  <td className="text-right">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`${match.url}/${recipe.id}/edit?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="primary"
                        size="sm"
                      >
                      ...
                      <Button
                        tag={Link}
                        to={`${match.url}/${recipe.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="danger"
                        size="sm"
                      >

  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="recipesApp.author.home.createOrEditLabel">Create or edit a Author</h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : authorEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="websiteLabel" for="author-website">
                  Website
                </Label>
                <AvField id="author-website" type="text" name="website" />
              </AvGroup>
